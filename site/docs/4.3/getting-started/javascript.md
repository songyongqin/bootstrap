...
Due to some browser limitation, some of our plugins, namely Dropdown/Tooltip/Popovers, cannot be used in a `<script>` tag with `module` type because they depend on Popper.js. For more information see [here](https://developers.google.com/web/fundamentals/primers/modules#specifiers).
{% endcapture %}
